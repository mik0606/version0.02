...
const features = [
  {
    icon: <Activity className="w-12 h-12 text-blue-400 mb-4" />,
    title: "Patient Monitoring",
    desc: "Real-time vital sign tracking with AI-powered alerts for early detection of critical conditions."
  },
  {
    icon: <Heart className="w-12 h-12 text-rose-400 mb-4" />,
    title: "Care Coordination",
    desc: "Seamless communication between departments ensuring continuity of care and reduced errors."
  },
  {
    icon: <Stethoscope className="w-12 h-12 text-blue-400 mb-4" />,
    title: "Resource Management",
    desc: "Optimize staff schedules and equipment usage to improve operational efficiency."
  }
];
  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-20">
          ...
          >
            <div className="space-y-8">
              <motion.div
                className="inline-flex items-center px-6 py-3 bg-blue-500/15 backdrop-blur-md rounded-2xl border border-blue-500/30"
              ...
              >
                ...
                <span className="text-sm text-blue-600 font-semibold tracking-wide">Advanced Healthcare Solutions</span>
              </motion.div>
            ...
            >
              <motion.img
                ...
                whileHover={{
                  boxShadow: "0 35px 60px -15px rgba(59, 130, 246, 0.3)",
                  transition: { type: "spring", stiffness: 400 }
                }}
              />
      ...
      <main className="pt-20 pb-16 relative z-10">
        <section className="py-24 bg-gradient-to-br from-blue-500/5 via-cyan-500/5 to-indigo-500/5">
          <motion.h2
            ...
            <AnimatePresence>
              {features.map((feature, idx) => {
                ...
                return (
                  <motion.div
                    key={idx}
                    className="absolute w-full max-w-sm h-[420px] bg-white/95 backdrop-blur-lg rounded-3xl p-10 border border-blue-100/60 shadow-2xl cursor-pointer flex flex-col items-center justify-center relative overflow-hidden"
                    ...
                    style={{
                      zIndex,
                      boxShadow: isActive
                        ? "0 35px 60px -15px rgba(59, 130, 246, 0.4), 0 20px 40px -20px rgba(37, 99, 235, 0.3)"
                  ...
                  >
                    ...
                    <motion.div
                      className={`absolute bottom-6 w-3 h-3 rounded-full ${isActive ? 'bg-gradient-to-r from-blue-400 to-cyan-400' : 'bg-slate-300'
                        }`}
                      animate={{
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              ...
              <motion.div
                ...
                whileHover={{
                  y: -8,
                  scale: 1.02,
                  boxShadow: "0 35px 60px -15px rgba(59, 130, 246, 0.35)"
                }}
                transition={{ type: "spring" as const, stiffness: 400, damping: 25 }}
              >
                <motion.div
