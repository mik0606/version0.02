...
import { ArrowRight, Play, Check, ShieldPlus, MapPin, Gauge, Battery, Zap, Package, Truck } from 'lucide-react';
...
const buttonHoverVariants: Variants = {
  rest: {
    scale: 1,
    boxShadow: "0 8px 25px -5px rgba(34, 197, 94, 0.15), 0 4px 10px -4px rgba(22, 163, 74, 0.1)"
  },
  hover: {
    scale: 1.08,
    boxShadow: "0 25px 50px -12px rgba(34, 197, 94, 0.35), 0 12px 24px -8px rgba(22, 163, 74, 0.2)",
...
const secondaryButtonVariants: Variants = {
  rest: {
    ...
    boxShadow: "0 8px 25px -5px rgba(34, 197, 94, 0.1), 0 4px 10px -4px rgba(22, 163, 74, 0.05)"
  },
  hover: {
    scale: 1.08,
    ...
    boxShadow: "0 25px 50px -12px rgba(34, 197, 94, 0.25), 0 12px 24px -8px rgba(22, 163, 74, 0.15)",
    transition: buttonTransition
  },
  tap: {
    scale: 0.92,
    ...
    <div className="min-h-screen bg-slate-50 overflow-hidden font-sans selection:bg-green-100 selection:text-green-900">
      ...
      <section className="relative w-full min-h-screen flex items-center pt-16 pb-12 lg:pt-12">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          {/* Main Gradient Mesh */}
          <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_top_left,_var(--tw-gradient-stops))] from-green-200/40 via-green-50/20 to-transparent" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
                ...
                <div className="text-center sm:text-left py-4">
                  <h1 className="font-display text-5xl sm:text-6xl lg:text-7xl font-bold text-slate-900 leading-tight tracking-tight pb-2">
                    ...
                    <motion.span
                      ...
                      style={{
                        backgroundImage: "linear-gradient(110deg, #15803d 45%, #86efac 50%, #15803d 55%)",
              ...
              <motion.div variants={itemVariants} className="flex flex-wrap gap-4">
                <motion.button
                  ...
                  whileHover="hover"
                  whileTap="tap"
                  className="flex items-center gap-2 px-8 py-4 bg-green-600 text-white rounded-xl font-semibold shadow-lg shadow-green-500/20"
                >
                  Request a Demo
            ...
            >
              <div className="relative w-full max-w-2xl">
                ...
                <div
                  className="relative rounded-3xl shadow-2xl shadow-green-900/10 border-4 border-white aspect-[4/3] w-full p-3 bg-white"
                  ...
                  <div className="relative w-full h-full rounded-2xl overflow-hidden isolation-isolate transform-gpu">
                    <AnimatePresence mode="sync">
                      <motion.img
                        ...
                        alt={`Transport Dashboard Interface ${currentImageIndex + 1}`}
                        initial={{ opacity: 0 }}
                        animate={{
                          opacity: 1,
                    ...
                    {/* Overlay Gradient */}
                    <div className="absolute inset-0 bg-gradient-to-t from-green-900/10 to-transparent pointer-events-none z-10" />
                  </div>
                </div>

                {/* Floating Badge 1 - Efficiency */}
                <motion.div
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-slate-900">Maximized</p>
                  </div>
                </motion.div>

                {/* Floating Badge 2 - Safety */}
                <motion.div
                ...
                >
                  ...
                  <div>
                    <p className="text-xs text-slate-500 font-bold uppercase tracking-wider">Safety</p>
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="container mx-auto px-6">
          <div className="mb-16 text-center">
            <h2 className="text-3xl md:text-4xl font-bold font-heading text-slate-900 mb-4">Complete Fleet Solutions</h2>
            <p className="text-slate-600 max-w-2xl mx-auto">Everything you need to manage your transport logistics, integrated into one seamless platform.</p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-2 h-[800px] lg:h-[500px] w-full max-w-7xl mx-auto">
            {[
              ...
              <div
                key={index}
                className="relative flex-1 hover:flex-[4] transition-all duration-500 ease-in-out group overflow-hidden rounded-2xl cursor-pointer border border-slate-200 hover:border-green-400/50 shadow-sm hover:shadow-green-900/20"
              >
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center p-4 text-white">
                  ...
                  <div className="opacity-0 group-hover:opacity-100 transition-all duration-500 transform translate-y-4 group-hover:translate-y-0 delay-0 group-hover:delay-200 flex flex-col items-center text-center">
                    ...
                    <p className="text-green-50 max-w-xs leading-relaxed drop-shadow-md font-medium">{feature.desc}</p>
                  </div>
                </div>
              </div>
            ))}
