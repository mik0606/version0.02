...
// Particle system component for Office
const OfficeParticlesBackground = () => {
...
const secondaryButtonVariants: Variants = {
  rest: {
    ...
    boxShadow: "0 8px 25px -5px rgba(168, 85, 247, 0.1), 0 4px 10px -4px rgba(236, 72, 153, 0.05)"
  },
  hover: {
    scale: 1.08,
  ...
  return (
    <div className="min-h-screen bg-background overflow-hidden">
      ...
      <div className="fixed inset-0 -z-5 overflow-hidden">
        ...
        />
        <motion.div
          className="absolute bottom-40 left-20 w-6 h-6 bg-pink-400/30 rounded-full"
          animate={{
            y: [0, 40, 0],
            x: [0, 10, 0],
          }}
            ...
            <div className="space-y-8">
              ...
              >
                <motion.div
                  ...
                  whileTap="tap"
                >
                  <Button size="lg" onClick={() => navigate('/demo', { state: { product: 'Office' } })} className="bg-purple-500 hover:bg-purple-600 text-white font-bold text-lg px-10 py-7 rounded-2xl shadow-2xl">
                ...
                <motion.div
                  ...
                  whileTap="tap"
                >
                  <Button size="lg" variant="outline" onClick={() => navigate('/demo', { state: { product: 'Office' } })} className="border-2 font-bold text-lg px-10 py-7 rounded-2xl backdrop-blur-md relative overflow-hidden">
                    <motion.div
            ...
            >
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-semibold text-pink-600">89% Goal Completion</span>
                </div>
              </motion.div>
            </motion.div>
          </motion.div>
      ...
      <main className="pt-20 pb-16 relative z-10">
              ...
              {features.map((feature, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <motion.div
                      className="absolute inset-0 bg-gradient-to-br from-purple-50/50 to-pink-50/30"
                ...
                <ul className="space-y-5 relative z-10">
                  {[
                    ...
                    <motion.li
                      ...
                      whileHover={{ x: 5 }}
                    >
                      <Check className="w-6 h-6 text-purple-500 mt-0.5 flex-shrink-0" />
                      <span>{item}</span>
                    </motion.li>
                  ))}
                </ul>
        ...
        <section className="py-24 container mx-auto px-4">
          ...
          >
            {/* Animated background elements */}
            <motion.div
              className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-purple-400 via-pink-400 to-violet-400"
              animate={{
                scaleX: [0, 1, 0],
            ...
            <motion.div
              ...
              whileTap="tap"
            >
              <Button size="lg" onClick={() => navigate('/demo', { state: { product: 'Office' } })} className="bg-purple-500 hover:bg-purple-600 text-white font-black text-xl px-14 py-8 rounded-2xl shadow-2xl">
                <motion.span
                  whileHover={{
                    scale: 1.1,
                    x: 5
