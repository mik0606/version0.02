              ...
              <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-center gap-8">
                ...
                <div className="relative group">
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-purple-900/5 blur-2xl rounded-full transform scale-90" />
                    ...
                    >
                      <svg viewBox="0 0 200 200" className="w-full h-full text-[#7e22ce] opacity-95 mix-blend-multiply">
                        <defs>
                          {/* Refined Grunge Filter - Clearer Text */}
                          <filter id="purple-grunge" x="-20%" y="-20%" width="140%" height="140%">
                            <feTurbulence type="fractalNoise" baseFrequency="0.05" numOctaves="2" result="noise" />
                            <feDisplacementMap in="SourceGraphic" in2="noise" scale="1" />
                          </filter>
                        </defs>

                        <g filter="url(#purple-grunge)">
                          {/* Outer Double Border */}
                          ...
                          <g transform="translate(76, 76) scale(1.5)">
                            <Building2 className="w-16 h-16" strokeWidth={2.5} />
                          </g>
                        </g>
                      </svg>
                    </motion.div>
