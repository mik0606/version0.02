...
import { Code, Smartphone, Cloud, ShieldCheck, Wrench, Cpu } from "lucide-react";
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-lg border-b border-border">
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/contact"><Button size="sm" className="bg-gradient-primary">Contact Us</Button></Link>
          </div>
      ...
      {productsOpen && (
        <div
          ...
          style={{ top: "64px" }}
        >
          <div className="w-full bg-[#F7FAFC] border-t border-border">
            ...
            <div className="h-[calc(100vh-64px)] overflow-y-auto">
              <div className="mx-auto max-w-7xl px-6 py-10">
                <div className="grid grid-cols-12 gap-8 items-start">
                  ...
                  {/* LEFT BOX */}
                  <div className="col-span-3 pr-6 border-r border-gray-200">
                    <h3 className="text-lg font-bold text-[#0E224B] mb-3">
                      MoviCloud Platform
                    </h3>
                  ...
                  <div className="col-span-6 px-6">
                    <div className="grid grid-cols-2 gap-y-6 gap-x-10">
                      ...
                      <Item name="Transport Management" desc="Optimize fleet operations with real-time GPS tracking, intelligent route planning, and predictive maintenance powered by advanced AI." link="/products/transport" />
                      <Item name="Office / Work Management" desc="Empower your team with intelligent task management, seamless collaboration, and AI-driven productivity insights." link="/products/office" />
                      <Item name="School & Alumni" desc="Comprehensive educational management platform with student records, attendance tracking, academic analytics, and alumni networking." link="/products/school" />
                    </div>
                  </div>

                  {/* RIGHT PRODUCTS */}
                  <div className="col-span-3 pl-6 space-y-6">
                    <Item name="E-commerce Inventory" desc="Advanced inventory tracking with AI-powered demand forecasting, automated stock replenishment, and real-time analytics.

" link="/products/Ecommerce" />
                    <Item name="Hotel & Hospitality" desc="Premium hospitality platform with booking management, guest services, revenue optimization, and AI-driven guest experience." link="/products/Hotel" />
                    <Item name="Survey System" desc="Intelligent feedback collection with AI-powered sentiment analysis, real-time analytics, and actionable insights.

" link="/products/survey" />
                    <Item name="Marketing Suite" desc="Complete marketing platform with AI-powered SEO tools, social media management, content creation, animation, and comprehensive campaign analytics." link="/products/Marketing" />
                  </div>
  ...
  <Solution icon={<Cpu className="w-6 h-6 text-[#2C6BED]" />} title="AI & Automation" desc="Smart workflow intelligence" />
      ...
      {isOpen && (
        <div className="md:hidden pb-4 space-y-4 bg-background animate-fade-in">
          <Link to="/" onClick={() => setIsOpen(false)} className="block hover:text-primary">Home</Link>
          <Link to="/products" onClick={() => setIsOpen(false)} className="block hover:text-primary">Products</Link>
...
const Item = ({ name, desc, link }: { name: string; desc: string; link: string }) => (
  <div>
    <h4 className="text-sm font-semibold hover:text-[#2C6BED]">
