    ...
    <div className="min-h-screen bg-slate-50 font-sans selection:bg-sky-100 selection:text-sky-900">
      ...
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-24 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-sky-50 border border-sky-100 text-sky-700 text-xs font-bold uppercase tracking-wider mb-6">
